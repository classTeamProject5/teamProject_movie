    ...
    <form method="post" action="../member/login_ok.do" id="joinFrm" name="joinFrm">
     <table class="table">
       ...
       <tr>
         ...
         <td width=30% class="inline">
           <select name=tel1 class="input-sm">
            <option>010</option>
            <option>011</option>
           </select>
           <input type=text name=tel2 size=30 class="input-sm" id=tel2>
         </td>
       </tr>
       <tr>
       ...
       <tr>
         <td colspan="2" width=50% class="text-center inline">
           <input type=button value="회원가입" class="btn btn-purple" id=sendBtn>
