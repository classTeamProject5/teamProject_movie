...
<body>
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="#" method="post">
                                <div class="row">
               						<div class="col-12 mb-3">
                                        <textarea name="comment" class="form-control w-100" id="comment" cols="30" rows="10" placeholder="나의 1:1 문의내역"></textarea>
                                    </div>
                            ...
                            <form action="#" method="post">
                                <div class="row">
               						<div class="col-12 mb-3">
                                        <textarea name="comment" class="form-control w-100" id="comment" cols="30" rows="10" placeholder="1:1문의 답변 순서"></textarea>
                                    </div>
 ...
 <!-- Button Group -->
  			...
  			<div class="amado-btn-group mt-30 mb-100">
                <a href="#" class="btn amado-btn mb-15">1:1문의하기 </a><br>
                <a href="#" class="btn amado-btn mb-15">자주묻는 질문 답변하기 </a>
