...
<body>
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="#" method="post">
                                <div class="row">
               						<div class="col-12 mb-3">
                                        <textarea name="comment" class="form-control w-100" id="comment" cols="30" rows="10" placeholder="나의 예매취소 내역 확인하기"></textarea>
                                    </div>
 ...
 <!-- Button Group -->
  			...
  			<div class="amado-btn-group mt-30 mb-100">
                <a href="#" class="btn amado-btn mb-15">이용안내 </a><br>
                <a href="#" class="btn amado-btn mb-15">티켓 교환안내 </a><br>
                <a href="#" class="btn amado-btn mb-15">예매 취소 안내 </a><br>
                <a href="#" class="btn amado-btn mb-15">환불 규정 안내 </a>
