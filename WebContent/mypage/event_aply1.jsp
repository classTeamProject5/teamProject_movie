        ...
        <div class="cart-table-area section-padding-100">
            <div class="container-fluid">
                <div class="row">
                   ...
                   <form action='click'>
 						 <input type='button'  value='응모내역' />
 						 <input type='button'  value='당첨자발표'  />
                            ...
                            <form action="#" method="post">
                                <div class="row">
               						<div class="col-12 mb-3">
                                        <textarea name="comment" class="form-control w-100" id="comment" cols="30" rows="10" placeholder="나의 응모내역"></textarea>
                                    </div>
