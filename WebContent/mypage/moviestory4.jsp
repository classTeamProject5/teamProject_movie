        ...
        <div class="cart-table-area section-padding-100">
            <div class="container-fluid">
                <div class="row">
                   ...
                   <form action='click'>
 						 <input type='button'  value='무비포스트' />
 						 <input type='button'  value='본영화'  />
 						 <input type='button'  value='관람평'  />
 						 <input type='button'  value='보고싶어'  />
                            ...
                            <form action="#" method="post">
                                <div class="row">
               						<div class="col-12 mb-3">
                                        <textarea name="comment" class="form-control w-100" id="comment" cols="30" rows="10" placeholder="보고싶은 나의 무비리스트"></textarea>
                                    </div>
